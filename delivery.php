...
<main class="page-delivery">
  ...
  <section class="page-delivery__info">
    ...
    <ul class="page-delivery__list">
      <li>
        <b class="page-delivery__item-title">Стандартная доставка - <?= $courierDeliveryPrice ?> РУБ / БЕСПЛАТНО (ДЛЯ ЗАКАЗОВ ОТ <?= $minSumOrderFreeShip ?> РУБ)</b>
      ...
      <li>
        <b class="page-delivery__item-title">Доставка с примеркой перед покупкой по Москве - <?= $courierDeliveryPrice ?> РУБ / БЕСПЛАТНО (ПРИ ВЫКУПЕ НА СУММУ ОТ <?= $minSumOrderFreeShip ?> РУБ)</b>
        <p class="page-delivery__item-desc">
