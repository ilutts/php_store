    ...
    <div class="shop-page__wrapper">
      ...
      <ul class="page-products__list">
        <li class="product-item page-products__item">
          ...
          <span class="product-item__field product-item__field--id">235454345</span>
          <span class="product-item__field product-item__field--price">2 500 руб.</span>
          <span class="product-item__field product-item__field--promo">Нет</span>
        </li>
      </ul>
      <form class="custom-form js-order">
        <input class="custom-form__input--product_id" type="hidden" name="product_id">
        <fieldset class="custom-form__group">
          ...
          <div class="custom-form__column">
            ...
            <label class="custom-form__input-wrapper" for="third_name">
        ...
        <div class="shop-page__delivery shop-page__delivery--yes" hidden="">
          <fieldset class="custom-form__group">
            ...
            <div class="custom-form__row">
              ...
              <legend class="custom-form__title">
                Бесплатная доставка от <span class="span-del-minsum"><?= $minSumOrderFreeShip ?></span> руб.
              </legend>
              <legend class="custom-form__title">
                Стоимость доставки: <span class="span-del-price"><?= $courierDeliveryPrice ?></span> руб.
              </legend>
              <legend class="custom-form__title">Итого к оплате: <span class="del-all-price">5552</span> руб.</legend>
            </div>
          </fieldset>
        </div>
  ...
  <section class="shop-page__popup-end" hidden="">
    <div class="shop-page__wrapper shop-page__wrapper--popup-end">
      ...
      <a href="<?= $_SERVER['REQUEST_URI'] ?>" class="button">Продолжить покупки</a>
    </div>
  </section>
</main>